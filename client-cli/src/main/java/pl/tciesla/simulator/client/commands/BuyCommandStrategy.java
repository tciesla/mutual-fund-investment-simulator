...
/**
 * Strategy enables buy mutual fund shares operation.
 */
public class BuyCommandStrategy implements CommandStrategy {
    ...
    private void performBuyRequest() {
        String request = "http://localhost:8080/simulator/customer/"
                + Defaults.getUsername() + "/buy/" + fundId + "/" + shareType + "/" + shareAmount;
